...
const PricingTier: React.FC<PricingTierProps> = ({
  ...
  <div
    className={`relative rounded-xl shadow-xl overflow-hidden transform transition-all duration-300 hover:scale-105 ${
      highlighted ? "border-2 border-green-500 z-10" : "border border-gray-700"
    }`}
    style={{
      opacity: 0,
  ...
  >
    ...
    <div
      className={`border-t border-gray-700 px-8 py-10 ${
        highlighted ? "bg-gray-800" : "bg-gray-900"
      } h-full`}
    >
        ...
        {features.map((feature, index) => (
          <li key={index} className="flex items-start">
            <div className="flex-shrink-0">
              <CheckCircle
                className={`h-6 w-6 ${
                  highlighted ? "text-green-500" : "text-green-400"
                }`}
              />
            </div>
  ...
  const tiers: PricingTierProps[] = [
    {
      ...
      price: annual ? "$49" : "$59",
      description:
        "Perfect for small teams and startups beginning their CI/CD journey.",
      features: [
    ...
    <section id="pricing" className="py-24 bg-gray-900">
      <div className="max-w-7xl mx-auto px-6 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          <h2
            className="text-green-500 font-semibold tracking-wide uppercase text-lg"
            style={{
              opacity: 0,
          ...
          <p
            className="mt-3 text-3xl leading-9 font-extrabold tracking-tight text-white sm:text-5xl sm:leading-10"
            style={{
              opacity: 0,
          ...
          <p
            className="mt-5 max-w-2xl text-xl text-gray-400 mx-auto"
            style={{
              opacity: 0,
              animation: "fadeIn 0.5s ease-out 0.2s forwards",
            }}
          >
            Choose the perfect plan to accelerate your development workflow with
            our AI-powered CI/CD platform.
          </p>

          {/* Billing toggle */}
          <div className="mt-10 flex justify-center">
            <div
              className="relative bg-gray-800 p-1 rounded-lg inline-flex shadow-lg"
              style={{
                opacity: 0,
            ...
            >
              ...
              >
                ...
                <span
                  className={`${
                    annual ? "block" : "hidden"
                  } absolute -top-3 -right-3 px-2 py-0.5 text-xs font-semibold rounded-full bg-green-500 text-white shadow-lg`}
                >
                  Save 20%
                </span>
              </button>
